module.exports = {
  ...
  SupportServer: "ServerLink", //Support Server Link
  Token: process.env.Token || "Token", //Discord Bot Token
  ClientID: process.env.Discord_ClientID || "ClientiD", //Discord Client ID
  ClientSecret: process.env.Discord_ClientSecret || "SecretID", //Discord Client Secret
  ...
  IconURL:
    "https://raw.githubusercontent.com/DarkZo0m/QMusic/master/assets/logo.gif", //URL of all embed author icons | Dont edit unless you dont need that Music CD Spining
